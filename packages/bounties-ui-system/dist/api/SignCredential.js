...
var SignCredentialView = function SignCredentialView(_ref2) {
  var box = _ref2.box,
...
SignCredentialView.defaultProps = {
  loggedOutLabel: 'Sign Credential',
...
var SignCredential = function SignCredential(props) {
  return _react["default"].createElement(_boxUiState.BoxInject, null, _react["default"].createElement(SignCredentialView, props));
};
