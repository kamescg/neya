...
var _comments = _interopRequireDefault(require("react-icons/lib/fa/comments"));

var _close = _interopRequireDefault(require("react-icons/lib/fa/close"));

var _moreVert = _interopRequireDefault(require("react-icons/lib/md/more-vert"));

var _cropSquare = _interopRequireDefault(require("react-icons/lib/md/crop-square"));

var _timeago = require("timeago.js");

var _loremIpsum = _interopRequireDefault(require("lorem-ipsum"));
      ...
      switch (type) {
        case 'message':
          ...
          return {
            ...
            theme: 'white',
            view: 'list',
            title: (0, _loremIpsum["default"])({
              count: 2,
              units: 'words'
            }),
            titleColor: this.getRandomColor(),
            text: type === 'spotify' ? 'spotify:track:7wGoVu4Dady5GV0Sv4UIsx' : (0, _loremIpsum["default"])({
              count: 1,
              units: 'sentences'
            }),
            data: {
        ...
        case 'chat':
          return {
            ...
            date: new Date(),
            subtitle: (0, _loremIpsum["default"])({
              count: 1,
              units: 'sentences'
            }),
            ...
            dropdownMenu: _react["default"].createElement(_reactChatElements.Dropdown, {
              ...
              buttonProps: {
                ...
                color: '#cecece',
                icon: {
                  component: _react["default"].createElement(_moreVert["default"], null),
                  size: 24
                }
              },
              items: [{
                icon: {
                  component: _react["default"].createElement(_cropSquare["default"], null),
                  "float": 'left',
                  color: 'red',
                  size: 22
                },
      ...
      return _react["default"].createElement("div", {
        ...
        , {
          ...
          headerButtons: [{
            ...
            icon: {
              component: _react["default"].createElement(_close["default"], null),
              size: 18
            }
          }],
        ...
        bottom: _react["default"].createElement("span", null, _react["default"].createElement(_reactChatElements.Button, {
          ...
          color: "black",
          icon: {
            component: _react["default"].createElement(_comments["default"], null),
            size: 18
          }
          ...
          color: "black",
          icon: {
            component: _react["default"].createElement(_search["default"], null),
            size: 18
          }
        }), _react["default"].createElement(_reactChatElements.Button, {
          text: "Count"
