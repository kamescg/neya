  ...
  return (
    <Context.Provider
      ...
      /* -------------------------------- */
        ...
        getSpace: ({ address, space }) =>
          dispatch({
            type: 'GET_SPACE_REQUEST',
            address: address.toLowerCase(),
            space
          }),
        listSpaces: ({ address, space }) =>
          dispatch({
        ...
        getThread: ({ space, threadName, firstModerator, members, options }) =>
          dispatch({
        ...
        getThreadByAddress: ({ threadAddress }) =>
          dispatch({
            type: 'GET_THREAD_BY_ADDRESS_REQUEST',
            threadAddress
          }),
        listenThread: ({ threadAddress, threadName }) =>
          dispatch({
      ...
      /* -------------------------------- */
        ...
        set: ({ keys, key, insert, inputs, access, space, append, update }) =>
          dispatch({
            type: 'SET_REQUEST',
         ...
         * deprecate setInsert.
         */
        setMerge: ({ access, space, key, delta, value }) =>
          dispatch({
        ...
        setSingle: ({ access, key, value, space }) =>
          dispatch({
        ...
        setMultiple: ({ space, access, keys, inputs }) =>
          dispatch({
         ...
         */
        insert: ({ space, access, index, key, value }) =>
          dispatch({
            type: 'INSERT_REQUEST',
         ...
         * @todo ADD THIS FEATURE EVERYWHERE
         */
        filter: ({ space, access, index, filter }) =>
          dispatch({
            type: 'FILTER_REQUEST',
            address: state.address,
            space,
        ...
        joinThread: ({ space, threadName, threadAddress, options }) =>
          dispatch({
        ...
        threadPost: ({ space, threadName, post }) =>
          dispatch({
        ...
        threadPostDelete: ({ space, threadName, postId }) =>
          dispatch({
